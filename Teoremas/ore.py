...
def verificaOre():
    ...
    for v in listaNaoAdjacente:
            if sum(frequencia[listaNaoAdjacente[indice][0]] + frequencia[listaNaoAdjacente[indice][1]]) >= vertices:
                ore += 1
                indice += 1
            else:
                pass
    ...
    if ore == len(listaNaoAdjacente):
        print('O grafo cumpre com os requisitos do teorema de Ore!')
    else:
        print("O grafo nao cumpre com os requisitos do teorema de Ore!")
